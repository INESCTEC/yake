...
<div className="not-prose mt-4">
  <div className="rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/30 p-4">
    <h4 className="font-semibold text-blue-700 dark:text-blue-300 mb-2">💡 Optional Dependencies</h4>
    <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
      For lemmatization support (optional but recommended):
    </p>
    <div className="bg-gray-900 dark:bg-gray-950 text-gray-100 p-3 rounded text-sm">
      <code>pip install spacy && python -m spacy download en_core_web_sm</code>
    </div>
  </div>
</div>
    ...
    <table className="w-full text-sm">
      ...
      <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <tr className="bg-gray-50 dark:bg-gray-800/50">
          ...
          <td className="px-4 py-3">Deduplication method: levs, jaro, or seqm</td>
        </tr>
        <tr className="bg-white dark:bg-gray-900">
...
<Tabs items={['Basic', 'From File', 'Advanced', 'Lemmatization']}>
  ...
  <Tab value="Advanced">
    ...
    yake -i article.txt -l en -n 3 -df levs -dl 0.8 -ws 2 -t 15 -v
    ```
  </Tab>
...
<div className="not-prose grid md:grid-cols-3 gap-6 my-8">
  ...
  <div className="group rounded-xl border-2 border-green-200 dark:border-green-800 bg-white dark:bg-gray-800 p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
    <div className="flex items-center gap-3 mb-4">
      ...
      <h3 className="text-lg font-bold">SequenceMatcher</h3>
    </div>
    <div className="mb-3">
    ...
    <table className="w-full text-sm">
      ...
      <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
        <tr className="bg-blue-50 dark:bg-blue-950/30">
          <td className="px-4 py-3 font-mono font-bold text-blue-600 dark:text-blue-400">levs</td>
...
<Callout type="tip" title="💡 Recommendation">
  For most use cases, **`levs` (Levenshtein)** provides the best balance between accuracy and performance. Use `jaro` for proper names or short strings, and `seqm` for longer texts with shared subsequences.
</Callout>
